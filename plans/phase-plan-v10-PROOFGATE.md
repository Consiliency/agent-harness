...
- `PYTHONPATH=phase-loop-runtime/tests uv run --project phase-loop-runtime python -m proofgate_content_tdd_adapter verify-scope --repo . --landing-ref origin-main --identity proofgate-tests-freeze --head HEAD --plan plans/phase-plan-v10-PROOFGATE.md`
