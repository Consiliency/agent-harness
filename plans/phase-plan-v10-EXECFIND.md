...
roadmap_sha256: 3e465669d4a30be1334e40c6998a6f5aae610d7204b94346bdd27ab1f0c4a9b0
automation:
  suite_command:
    - bash
    - -lc
...
- [ ] EC-EXECFIND-3 — proven by `PHASE_LOOP_TDD_REQUIRE_EXECFIND_GREEN=1 PYTHONPATH=phase-loop-runtime/src python3 -m pytest -q phase-loop-runtime/tests/test_governed_review.py -k "finding_bound or finding_reviewed_sha_mismatch or finding_unbound or finding_receipt or finding_receipt_digest_unresolved or falsifier_count_bound or finding_prose or degraded_leg_whole_code"`; falsified by a path-entered mutation defeating any node in that selector.
