...
- **Post-landing default-order amendment** (agent-harness#1027, maintainer 2026-09-24): on the amendment's merge, the built-in order follows EC-PRESROUTE-3 as amended. The original order and SL-0 content receipt remain historical evidence of agent-harness#998's landing; this amendment neither rewrites that receipt nor changes the configured-ladder precedence.
