...
The strict dependency verifier is the following exact `57896`-byte UTF-8/LF Python source at SHA-256 `3423d849b1f5a2c5d03ce5bbe0333289281eb0d3b9ac075016ec4b9e2ee7abad`. The second Stage-A command extracts only these marked bytes from this plan into the private external `$REVIEWTRUTH_RUNNER_ROOT.stage-a-review-wave-verifier.py`, verifies both constants before execution, and never imports REVIEWTRUTH production code.
