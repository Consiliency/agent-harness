...
The strict dependency verifier is the following exact `58204`-byte UTF-8/LF Python source at SHA-256 `f16f407c4950dcddc3902f6126d3b2c2ddce20a166e7cac42e8804372242e618`. The second Stage-A command extracts only these marked bytes from this plan into the private external `$REVIEWTRUTH_RUNNER_ROOT.stage-a-review-wave-verifier.py`, verifies both constants before execution, and never imports REVIEWTRUTH production code.
