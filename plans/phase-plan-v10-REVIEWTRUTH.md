...
The strict dependency verifier is the following exact `36945`-byte UTF-8/LF Python source at SHA-256 `2d48c64491cda39391c1388f229f1304955c5dcb51a3df5eea4a56f00baeeb5f`. The second Stage-A command extracts only these marked bytes from this plan into the private external `$REVIEWTRUTH_RUNNER_ROOT.stage-a-review-wave-verifier.py`, verifies both constants before execution, and never imports REVIEWTRUTH production code.
