...
The current immutable exact panel at `.phase-loop/reviews/v10-reviewtruth-plan-panel.json` has
file SHA-256 `8a30abffe37a9060ccf8bacdca668dc8e1a236fd2aac1062887646c2b7fdba0b`.
It reviewed predecessor plan SHA-256
...
- **Scope**: On the exact clean pre-edit base that already contains the separately committed planning lock prerequisite, execute the exact-digest external bootstrap observer in one controlled pytest process; then land the complete REVIEWTRUTH falsifier and compatibility migration suite, deterministic marker activation, CI-safe dual-mode post-parser collection, the strict typed degraded-seat append/read/rewrite/reread contract, the exact-node PyPI availability disposition and RED falsifier, non-colliding native request/attempt identity tests, structured JUnit contract, and panel-reviewed RED record before any production file changes.
...
- Plan review is a pre-dispatch gate, not a lane. The current panel artifact SHA-256 `8a30abffe37a9060ccf8bacdca668dc8e1a236fd2aac1062887646c2b7fdba0b`, its reviewed predecessor `4c7a4411c28c89ca365bb2b37d6961affa84c4845de84a370d6f5821b0760668`, and Sol's PyPI skip nondeterminism dissent are immutable historical evidence only; Fable is absent, and neither that predecessor digest nor this repaired digest is approved. Record a fresh exact repaired-plan digest, executor/model/effort, Fable/Sol reviewed outcomes, all four seat outcomes, and resolution of every material finding in the canonical runner ledger before SL-0. Any changed byte after that review requires another exact-digest panel.
