...
The strict dependency verifier is the following exact `57500`-byte UTF-8/LF Python source at SHA-256 `14f9f24427b7d6335b8aa9d9b703536a82a6f397f54bfec09df8482fe4df4e29`. The second Stage-A command extracts only these marked bytes from this plan into the private external `$REVIEWTRUTH_RUNNER_ROOT.stage-a-review-wave-verifier.py`, verifies both constants before execution, and never imports REVIEWTRUTH production code.
...
def validate_receipt(receipt, expected_base, root, forbidden, receipt_digest, final, label):
    ...
    for index, (seat, expected) in enumerate(zip(seats, roster)):
        ...
        prompt_ref, prompt_digest = validate_rendered_prompt(
            ...
            required_evidence=[receipt["base"]["final_audit"], receipt["base"]["final_evidence"]],
        ...
        grounded = receipt["base"]["final_audit"] in native_grounding and receipt["base"]["final_evidence"] in native_grounding
