...
The strict dependency verifier is the following exact `58053`-byte UTF-8/LF Python source at SHA-256 `f7aed3509675f5edff2617e09d7617c1f7047a13adee44ed940fc3f23f376896`. The second Stage-A command extracts only these marked bytes from this plan into the private external `$REVIEWTRUTH_RUNNER_ROOT.stage-a-review-wave-verifier.py`, verifies both constants before execution, and never imports REVIEWTRUTH production code.
