...
| Consiliency/agent-harness#851 | production_code | exact final head recorded in the PR body | diagnostic sidecar and private session retention; landing conditional on four usable exact-head AGREE reviews from native Fable, Astra, Gemini and Grok, required green CI, and this exception remaining active; failed reviews and follow-up disposition are retained on the PR |
