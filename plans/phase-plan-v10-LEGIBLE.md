...
| LEGIBLE-A2-LOCAL-VERSION | agent-harness ships `0.7.19` | `phase-loop-runtime/pyproject.toml` and `phase_loop_runtime.__version__` both equal `0.7.19` | change either surface alone to `0.7.20` | current equal pair passes |
