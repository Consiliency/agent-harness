...
- CI now checks out full history for source and clean-room test lanes. When the
  ...
  evidence and Gate A fails unless site-packages and the installed wheel retain import
  precedence. Legacy candidates retain the existing tests-only clean-room layout.
