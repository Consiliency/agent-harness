...
PRESERVE_LITERALS: tuple[str, ...] = (
    ...
    # the skills now name claude-opus-5 (frontier + planning), claude-opus-5-5
    # (executor ultra + independent presets) and claude-fable-5-1 (panel default). The
    ...
    "claude-opus-5-5",  # model-id-source: verbatim literal preserved through brand-collapse (ultra tier + independent presets)
    "claude-opus-5",  # model-id-source: verbatim literal preserved through brand-collapse (heavy tier)
    "claude-fable-5-1",  # model-id-source: verbatim literal preserved through brand-collapse (panel default)
