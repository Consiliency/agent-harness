...
class PhaseLoopPolicyTest(unittest.TestCase):
    ...
    def test_default_profiles_freeze_planning_execution_review_posture(self):
        self.assertEqual(DEFAULT_PROFILES["roadmap"], ("gpt-6-astra", "high"))
        self.assertEqual(DEFAULT_PROFILES["plan"], ("gpt-6-astra", "high"))
        self.assertEqual(DEFAULT_PROFILES["execute"], ("gpt-6-astra", "medium"))
        self.assertEqual(DEFAULT_PROFILES["repair"], ("gpt-6-astra", "medium"))
        self.assertEqual(DEFAULT_PROFILES["review"], ("gpt-6-astra", "high"))
        self.assertEqual(DEFAULT_PROFILES["skill-maintenance"], ("gpt-6-astra", "high"))
