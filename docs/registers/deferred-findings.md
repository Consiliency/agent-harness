...
- **disposition:** EXCLUDED — reproduced in package CI after substantive assertions; agent-harness#656 is in flight in a separate repair branch, outside agent-harness#883.
