...
# returning the superseded roadmap. Narrower remaining residual (explicit/handoff, manifest-disabled,
# status-vs-banner proxy) tracked in EC-LEGIBLE-7 and agent-harness#385.)
