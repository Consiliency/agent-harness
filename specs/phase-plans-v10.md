...
- [ ] EC-PRESROUTE-3 — **The ladder is ordered by seat alias, stated here once, on each
  ...
  (Claude, Astra, Grok, Gemini) — the 2026-09-24 maintainer ruling in agent-harness#1027
  supersedes the original Sol-first order. This criterion is the ONLY place the order is written; the
